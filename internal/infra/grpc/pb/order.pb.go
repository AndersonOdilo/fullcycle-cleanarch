...
type ListOrdersItemResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Price         float32                `protobuf:"fixed32,2,opt,name=price,proto3" json:"price,omitempty"`
	Tax           float32                `protobuf:"fixed32,3,opt,name=tax,proto3" json:"tax,omitempty"`
...
func (x *ListOrdersItemResponse) Reset() {
	*x = ListOrdersItemResponse{}
	mi := &file_internal_infra_grpc_protofiles_order_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListOrdersItemResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListOrdersItemResponse) ProtoMessage() {}

func (x *ListOrdersItemResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_infra_grpc_protofiles_order_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListOrdersItemResponse.ProtoReflect.Descriptor instead.
func (*ListOrdersItemResponse) Descriptor() ([]byte, []int) {
	return file_internal_infra_grpc_protofiles_order_proto_rawDescGZIP(), []int{3}
}

func (x *ListOrdersItemResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ListOrdersItemResponse) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *ListOrdersItemResponse) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *ListOrdersItemResponse) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
type ListOrdersResponse struct {
	state                  protoimpl.MessageState    `protogen:"open.v1"`
	ListOrdersItemResponse []*ListOrdersItemResponse `protobuf:"bytes,1,rep,name=listOrdersItemResponse,proto3" json:"listOrdersItemResponse,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ListOrdersResponse) GetListOrdersItemResponse() []*ListOrdersItemResponse {
	if x != nil {
		return x.ListOrdersItemResponse
	}
	return nil
}
...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"finalPrice\"\a\n" +
	"\x05blank\"q\n" +
	"\x16ListOrdersItemResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05price\x18\x02 \x01(\x02R\x05price\x12\x10\n" +
	"\x03tax\x18\x03 \x01(\x02R\x03tax\x12\x1f\n" +
	"\vfinal_price\x18\x04 \x01(\x02R\n" +
	"finalPrice\"h\n" +
	"\x12ListOrdersResponse\x12R\n" +
	"\x16listOrdersItemResponse\x18\x01 \x03(\v2\x1a.pb.ListOrdersItemResponseR\x16listOrdersItemResponse2\x7f\n" +
	"\fOrderService\x12>\n" +
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []any{
	...
	(*ListOrdersItemResponse)(nil), // 3: pb.ListOrdersItemResponse
	(*ListOrdersResponse)(nil),     // 4: pb.ListOrdersResponse
}
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	3, // 0: pb.ListOrdersResponse.listOrdersItemResponse:type_name -> pb.ListOrdersItemResponse
